...
const (
	PersonalShoppingService_Create_FullMethodName = "/personal.PersonalShoppingService/Create"
	PersonalShoppingService_GetAll_FullMethodName = "/personal.PersonalShoppingService/GetAll"
)
...
type PersonalShoppingServiceClient interface {
	...
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetShoppingItemsResponse, error)
}
...
func (c *personalShoppingServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetShoppingItemsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PersonalShoppingServiceServer interface {
	...
	GetAll(context.Context, *emptypb.Empty) (*GetShoppingItemsResponse, error)
...
func (UnimplementedPersonalShoppingServiceServer) GetAll(context.Context, *emptypb.Empty) (*GetShoppingItemsResponse, error) {
...
func _PersonalShoppingService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonalShoppingServiceServer).GetAll(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PersonalShoppingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "personal.PersonalShoppingService",
	...
	Metadata: "personal/shopping.proto",
}
